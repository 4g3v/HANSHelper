...
namespace HANSHelper
{
    ...
    class RomFSBuilder
    {
        ...
        private string RomFSDirectory;
        private string FileName;
        private string TempFile;

        public RomFSBuilder(string RomFSDirectory, string FileName)
        {
            this.RomFSDirectory = RomFSDirectory;
            this.FileName = FileName;
        }

        public void Build()
        {
            FileNameTable fnt = new FileNameTable(this.RomFSDirectory);
            ...
            for (int i = 0; i < Out.Length; i++)
            {
                ...
                romFiles[i].PathName = Out[i].FilePath.Replace(Path.GetFullPath(this.RomFSDirectory), "").Replace("\\", "/");
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                ...
                mdb.BuildRomFSHeader(memoryStream, romFiles, this.RomFSDirectory);
        ...
        private void MakeRomFSData(RomfsFile[] RomFiles, MemoryStream metadata)
        {
            ...
            Console.WriteLine("Writing Binary to " + this.FileName + "...");
            WriteBinary(TempFile, this.FileName);
        }
        private void WriteBinary(string tempFile, string outFile)
        {
